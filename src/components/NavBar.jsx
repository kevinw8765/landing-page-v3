...
const NavBar = () => {
  ...
  return (
    ...
    <div className = "flex justify-between items-center w-full h-20 text-white fixed bg-gradient-to-r bg-white bg-opacity-40 rounded-br-full rounded-bl-full px-10">
        <div>
        ...
        {nav && (
            <ul className = "flex flex-col justify-center items-center absolute top-0 left-0 w-full h-screen bg-gradient-to-b from-black to-gray-800 text-gray-500">
                {links.map(({id, link}) => (
                    <li key = {id} className = "text-4xl py-6 px-4 cursor-pointer capitalize font-medium text-gray-500 hover:scale-105 duration-200">
